            ...
            <div>
                <Carousel className="about-image" interval ={3000} keyboard = {false} pause = {false} infiniteLoop useKeyboardArrows autoPlay>
                    ...
                    <Carousel.Item>
                     ...
                     <Carousel.Item>
                            <img className = "about" src="https://www.irishtimes.com/polopoly_fs/1.3344131.1515006653!/image/image.jpg_gen/derivatives/box_620_330/image.jpg"/>
                     </Carousel.Item>
                     <Carousel.Item>
                             <img className = "about" src="https://investadvocate.com.ng/wp-content/uploads/2018/04/Stocks.jpg"/>
                     </Carousel.Item>
                     <Carousel.Item>
                             <img className = "about" src="https://www.bankrate.com/2019/01/25123256/How-to-buy-stocks.jpg" />
                    </Carousel.Item>
              </Carousel>
          </div>
        )
